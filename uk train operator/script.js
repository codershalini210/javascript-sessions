    // <input type="text" id="station-search-box">
...
// data ends
    ...
    const station_search_box = document.querySelector("#station_search_box")
    ...
    btn_search.addEventListener("click",()=>
    {
        ...
        if(value_to_search=="")
        {
            train_list.innerHTML = "<li>Please enter a station name "
            return 
        }
   ...
   train_list.innerHTML=""
        trainData[matchedStation].forEach(train => {
            ...
            li.innerHTML = ` ${train.time} -  ${train.destination} (${train.operator})
             | ${train.platform}  | status: ${train.status} | ${train.delay} mins` 
